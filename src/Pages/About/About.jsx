...
const About = () => {
    ...
    return (
        <section id="about"
            className="sticky bg-[#060918] text-white inset-2 h-screen w-full flex-col justify-center py-10 mb-20 overflow-hidden">
            <article className="md:flex justify-between items-center h-full text-center md:text-left">
                ...
                <div data-aos="fade-left" className="md:w-1/2 p-4 md:pl-0 md:pr-6 xl:pr-8">
