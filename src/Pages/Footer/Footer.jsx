...
import logo from "../../assets/logos/lokkeestudios.svg";
const Footer = () => {
    return (
        <section className='bg-black text-gray-200 py-24 mx-auto'>
            ...
            lg:grid-cols-[2fr_1fr_1fr_1fr_1fr] gap-12 '>
                <div className='space-y-5'>
                    ...
                    <p className="text-md text-justify text-gray-400">Explore, collaborate, contact. Let's bring your web development ideas to life. Thank you for visiting!</p>
